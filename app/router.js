...
module.exports = app => {
  ...
  app.router.get('/api/v1/balance/:accountId', app.controller.account.balance);
  app.router.get('/api/v1/systembalance/:accountId', app.controller.account.systemBalance);
